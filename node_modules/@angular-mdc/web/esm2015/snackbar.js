...
import { Component, ElementRef, EventEmitter, HostBinding, Output, ViewChild, ViewEncapsulation, Injectable, NgModule } from '@angular/core';
...
class MdcSnackbarComponent {
     ...
     * @param {?} _registry
     */
    constructor(elementRef, _registry) {
        ...
        this._mdcAdapter = {
            ...
            setMessageText: (message) => this._getSnackText().textContent = message,
