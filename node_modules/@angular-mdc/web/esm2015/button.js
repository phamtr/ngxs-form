 ...
 */
import { ChangeDetectionStrategy, Component, ContentChild, ElementRef, HostBinding, HostListener, Input, ViewEncapsulation, NgModule } from '@angular/core';
...
class MdcButton {
     ...
     * @param {?} _ripple
     */
    constructor(_elementRef, _ripple) {
...
MdcButton.propDecorators = {
    ...
    classPrimary: [{ type: HostBinding, args: ['class.ng-mdc-button--primary',] }],
    classSecondary: [{ type: HostBinding, args: ['class.ng-mdc-button--secondary',] }],
