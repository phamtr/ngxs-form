...
class MdcChip {
     ...
     * @param {?} _registry
     */
    constructor(_changeDetectorRef, _ripple, elementRef, _registry) {
        ...
        this._mdcAdapter = {
            ...
            setStyleProperty: (propertyName, value) => this._getHostElement().style.setProperty(propertyName, value)
        };
...
class MdcChipSet {
     ...
     * @param {?} _registry
     */
    constructor(_changeDetectorRef, _ngZone, elementRef, _registry) {
        this._changeDetectorRef = _changeDetectorRef;
