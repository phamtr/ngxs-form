 ...
 */
import { ElementRef, Injectable, ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, Input, NgZone, Renderer2, NgModule } from '@angular/core';
...
class MdcRipple {
     ...
     * @param {?} elementRef
     */
    constructor(_registry, elementRef) {
        ...
        this._mdcAdapter = {
            ...
            containsEventTarget: (target) => this._root.contains(target),
            registerInteractionHandler: (evtType, handler) => this._registry.listen(evtType, handler, this._interactionElement ? this._interactionElement : this._root, applyPassive()),
            deregisterInteractionHandler: (evtType, handler) => this._registry.unlisten(evtType, handler),
            registerDocumentInteractionHandler: (evtType, handler) => this._registry.listen(evtType, handler, document, applyPassive()),
            deregisterDocumentInteractionHandler: (evtType, handler) => this._registry.unlisten(evtType, handler),
            ...
            updateCssVariable: (varName, value) => this._root.style.setProperty(varName, value),
     ...
     * @return {?}
     */
    attachTo(root, unbounded = false, interactionElement) {
        this._root = root;
...
class MdcRippleComponent {
     ...
     * @param {?} elementRef
     */
    constructor(_ngZone, _changeDetectorRef, _ripple, _renderer, elementRef) {
     ...
     * @return {?}
     */
    get attachTo() { return this._attachTo; }
    /**
     * @param {?} element
     * @return {?}
     */
     ...
     * @return {?}
     */
    get unbounded() { return this._unbounded; }
    /**
     * @param {?} value
     * @return {?}
     */
...
/** @nocollapse */
MdcRippleComponent.ctorParameters = () => [
    { type: NgZone },
...
class MdcRippleDirective extends MdcRippleComponent {
    /**
     * @param {?} _ngZone
     * @param {?} _changeDetectorRef
     * @param {?} _ripple
...
export { MdcRippleModule, MdcRipple, MdcRippleComponent, MdcRippleDirective };
