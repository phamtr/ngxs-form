 ...
 */
import { Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, HostBinding, Input, Renderer2, ViewEncapsulation, NgModule } from '@angular/core';
...
MdcIcon.decorators = [
    { type: Component, args: [{selector: 'mdc-icon, [mdcIcon]',
...
MdcIcon.propDecorators = {
    ...
    isHostClass: [{ type: HostBinding, args: ['class.ng-mdc-icon',] }]
};
