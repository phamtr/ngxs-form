...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular-mdc/web/ripple'), require('rxjs/operators'), require('rxjs'), require('@angular-mdc/web/common'), require('@angular/common')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/appBar', ['exports', '@angular/core', '@angular-mdc/web/ripple', 'rxjs/operators', 'rxjs', '@angular-mdc/web/common', '@angular/common'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.appBar = {}),global.ng.core,global.ng.web.ripple,global.Rx.operators,global.Rx,global.ng.web.common,global.ng.common));
}(this, (function (exports,core,ripple,operators,rxjs,common,common$1) { 'use strict';
  ...
  function (_MDCTopAppBarBaseFoun) {
    ...
    _createClass(MDCShortTopAppBarFoundation, [{
      ...
      value: function init() {
        ...
        var isAlwaysCollapsed = this.adapter_.hasClass(cssClasses$1.SHORT_COLLAPSED_CLASS);
    ...
    _createClass(MDCTopAppBar, [{
      ...
      value: function initialize() {
        ...
        this.iconRipples_ = icons.map(function (icon) {
          var ripple$$1 = rippleFactory(icon);
          ripple$$1.unbounded = true;
          return ripple$$1;
        });
      }
    }, {
      ...
      value: function getDefaultFoundation() {
        ...
        Object.assign({
          ...
          notifyNavigationIconClicked: function notifyNavigationIconClicked() {
            _this2.emit(strings$1.NAVIGATION_EVENT, {});
          },
          ...
          getTotalActionItems: function getTotalActionItems() {
            return _this2.root_.querySelectorAll(strings$1.ACTION_ITEM_SELECTOR).length;
          }
        });
  ...
  var MdcAppBar = /** @class */ (function () {
      ...
      function (fixed, isUserInput) {
          ...
          this._fixed = common.toBoolean(fixed);
      ...
      function (prominent, isUserInput) {
          if (isUserInput === void 0) { isUserInput = true; }
          this._prominent = common.toBoolean(prominent);
      ...
      function (short, isUserInput) {
          if (isUserInput === void 0) { isUserInput = true; }
          this._short = common.toBoolean(short);
          if (this.short) {
      ...
      function (shortCollapsed, isUserInput) {
          if (isUserInput === void 0) { isUserInput = true; }
          this._shortCollapsed = common.toBoolean(shortCollapsed);
