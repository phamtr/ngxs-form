...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('@angular-mdc/web/portal'), require('@angular-mdc/web/ripple'), require('@angular-mdc/web/button'), require('rxjs/operators'), require('@angular-mdc/web/common')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/dialog', ['exports', '@angular/core', '@angular/common', 'rxjs', '@angular-mdc/web/portal', '@angular-mdc/web/ripple', '@angular-mdc/web/button', 'rxjs/operators', '@angular-mdc/web/common'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.dialog = {}),global.ng.core,global.ng.common,global.Rx,global.ng.web.portal,global.ng.web.ripple,global.ng.web.button,global.Rx.operators,global.ng.web.common));
}(this, (function (exports,core,common,rxjs,portal,ripple,button,operators,common$1) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  /*#__PURE__*/
  function (_MDCFoundation) {
    _inherits$1(MDCDialogFoundation, _MDCFoundation);

    _createClass$1(MDCDialogFoundation, null, [{
      key: "cssClasses",
      get: function get() {
        return cssClasses$1;
      }
    ...
    function MDCDialogFoundation(adapter) {
      ...
      _classCallCheck$1(this, MDCDialogFoundation);

      _this = _possibleConstructorReturn$1(this, _getPrototypeOf$1(MDCDialogFoundation).call(this, Object.assign(MDCDialogFoundation.defaultAdapter, adapter)));
      _this.isOpen_ = false;
    ...
    _createClass$1(MDCDialogFoundation, [{
      key: "destroy",
      value: function destroy() {
  ...
  /*#__PURE__*/
  function (_MDCComponent) {
    _inherits$1(MDCDialog, _MDCComponent);

    function MDCDialog() {
      _classCallCheck$1(this, MDCDialog);

      return _possibleConstructorReturn$1(this, _getPrototypeOf$1(MDCDialog).apply(this, arguments));
    }

    _createClass$1(MDCDialog, [{
      key: "initialize",
      value: function initialize() {
      ...
      key: "destroy",
      value: function destroy() {
        this.footerBtnRipples_.forEach(function (ripple$$1) {
          return ripple$$1.destroy();
        });

        _get$1(_getPrototypeOf$1(MDCDialog.prototype), "destroy", this).call(this);
      }
    }, {
      key: "show",
      value: function show() {
  ...
  var MdcDialogComponent = /** @class */ (function () {
       ...
       */
      function (event) {
          if (common$1.ESCAPE === event.keyCode) {
      ...
      MdcDialogComponent.decorators = [
          { type: core.Component, args: [{selector: 'mdc-dialog',
                      ...
                      providers: [common$1.EventRegistry],
                      encapsulation: core.ViewEncapsulation.None
                  },] },
      ];
      /** @nocollapse */
  ...
  var MdcDialog = /** @class */ (function () {
      ...
      function (component, dialogContainer, config) {
          ...
          var /** @type {?} */ contentRef = dialogContainer.attachComponentPortal(new portal.ComponentPortal(component, undefined, injector));
