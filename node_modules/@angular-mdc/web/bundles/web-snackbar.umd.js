...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('@angular-mdc/web/common'), require('rxjs/operators'), require('@angular-mdc/web/portal')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/snackbar', ['exports', 'rxjs', '@angular/core', '@angular-mdc/web/common', 'rxjs/operators', '@angular-mdc/web/portal'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.snackbar = {}),global.Rx,global.ng.core,global.ng.web.common,global.Rx.operators,global.ng.web.portal));
}(this, (function (exports,rxjs,core,common,operators,portal) { 'use strict';
  ...
  function (_MDCFoundation) {
    _inherits$1(MDCSnackbarFoundation, _MDCFoundation);

    _createClass$1(MDCSnackbarFoundation, [{
      key: "active",
      get: function get() {
        return this.active_;
      }
    ...
    function MDCSnackbarFoundation(adapter) {
      ...
      _classCallCheck$1(this, MDCSnackbarFoundation);

      _this = _possibleConstructorReturn$1(this, _getPrototypeOf$1(MDCSnackbarFoundation).call(this, Object.assign(MDCSnackbarFoundation.defaultAdapter, adapter)));
      _this.active_ = false;
      ...
      _this.visibilitychangeHandler_ = function () {
        ...
        if (!_this.adapter_.visibilityIsHidden()) {
          setTimeout(_this.cleanup_.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this))), _this.snackbarData_.timeout || numbers.MESSAGE_TIMEOUT);
        }
      };
      ...
      _this.blurHandler_ = function () {
        clearTimeout(_this.timeoutId_);
        _this.snackbarHasFocus_ = false;
        _this.timeoutId_ = setTimeout(_this.cleanup_.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this))), _this.snackbarData_.timeout || numbers.MESSAGE_TIMEOUT);
      };
  ...
  function (_MDCComponent) {
    _inherits$1(MDCSnackbar, _MDCComponent);

    function MDCSnackbar() {
      _classCallCheck$1(this, MDCSnackbar);

      return _possibleConstructorReturn$1(this, _getPrototypeOf$1(MDCSnackbar).apply(this, arguments));
    }

    _createClass$1(MDCSnackbar, [{
      key: "show",
      value: function show(data) {
  ...
  var MdcSnackbarComponent = /** @class */ (function () {
      function MdcSnackbarComponent(elementRef, _registry) {
          ...
          this._mdcAdapter = {
              ...
              visibilityIsHidden: function () { return common.isBrowser() ? document.hidden : false; },
  ...
  var MdcSnackbarModule = /** @class */ (function () {
      ...
      MdcSnackbarModule.decorators = [
          { type: core.NgModule, args: [{
                      ...
                      providers: [MdcSnackbar, portal.MdcPortalService],
