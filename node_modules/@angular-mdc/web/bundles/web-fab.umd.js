...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular-mdc/web/common'), require('@angular-mdc/web/ripple'), require('@angular-mdc/web/icon'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@angular-mdc/web/fab', ['exports', '@angular/core', '@angular-mdc/web/common', '@angular-mdc/web/ripple', '@angular-mdc/web/icon', '@angular/common'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.fab = {}),global.ng.core,global.ng.web.common,global.ng.web.ripple,global.ng.web.icon,global.ng.common));
}(this, (function (exports,core,common,ripple,icon,common$1) { 'use strict';
    ...
    var MdcFabModule = /** @class */ (function () {
        ...
        MdcFabModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [icon.MdcIconModule, common$1.CommonModule],
                        exports: [MdcFab],
                        declarations: [MdcFab],
                    },] },
        ];
