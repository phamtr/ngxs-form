...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular-mdc/web/common'), require('@angular-mdc/web/ripple'), require('@angular-mdc/web/icon')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/iconToggle', ['exports', '@angular/core', '@angular/forms', '@angular-mdc/web/common', '@angular-mdc/web/ripple', '@angular-mdc/web/icon'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.iconToggle = {}),global.ng.core,global.ng.forms,global.ng.web.common,global.ng.web.ripple,global.ng.web.icon));
}(this, (function (exports,core,forms,common,ripple,icon) { 'use strict';
  ...
  function (_MDCFoundation) {
    ...
    function MDCIconToggleFoundation(adapter) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(MDCIconToggleFoundation).call(this, Object.assign(MDCIconToggleFoundation.defaultAdapter, adapter)));
      /** @private {boolean} */
  ...
  function (_MDCComponent) {
    ...
    function MDCIconToggle() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MDCIconToggle)).call.apply(_getPrototypeOf2, [this].concat(args)));
      /** @private {!MDCRipple} */
    ...
    _createClass(MDCIconToggle, [{
      ...
      value: function destroy() {
        ...
        _get(_getPrototypeOf(MDCIconToggle.prototype), "destroy", this).call(this);
      }
      /** @return {!MDCIconToggleFoundation} */
  ...
  var MdcIconToggle = /** @class */ (function () {
      function MdcIconToggle(_changeDetectorRef, _renderer, elementRef, ripple$$1, _registry) {
          var _this = this;
       ...
       */
      function (primary) {
          this._primary = common.toBoolean(primary);
          this._changeDetectorRef.markForCheck();
      };
      /**
       * @param {?} secondary
       ...
       */
      function (secondary) {
          this._secondary = common.toBoolean(secondary);
          this._changeDetectorRef.markForCheck();
      };
      ...
      MdcIconToggle.propDecorators = {
          ...
          icon: [{ type: core.ViewChild, args: [icon.MdcIcon,] }]
      };
      return MdcIconToggle;
  }());
