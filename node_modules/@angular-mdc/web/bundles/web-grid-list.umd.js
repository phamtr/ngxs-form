...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('rxjs'), require('@angular-mdc/web/common'), require('@angular-mdc/web/icon')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/gridList', ['exports', '@angular/core', 'rxjs/operators', 'rxjs', '@angular-mdc/web/common', '@angular-mdc/web/icon'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.gridList = {}),global.ng.core,global.Rx.operators,global.Rx,global.ng.web.common,global.ng.web.icon));
}(this, (function (exports,core,operators,rxjs,common,icon) { 'use strict';
  ...
  function (_MDCFoundation) {
    ...
    function MDCGridListFoundation(adapter) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(MDCGridListFoundation).call(this, Object.assign(MDCGridListFoundation.defaultAdapter, adapter)));
  ...
  function (_MDCComponent) {
    ...
    function MDCGridList() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(MDCGridList).apply(this, arguments));
    }
  ...
  var MdcGridList = /** @class */ (function () {
      ...
      function () {
          ...
          this.icons.changes.pipe(operators.startWith(null), operators.takeUntil(this._destroy)).subscribe(function () {
              Promise.resolve().then(function () {
                  _this.icons.forEach(function (icon$$1) {
                      _this._renderer.addClass(icon$$1.elementRef.nativeElement, 'mdc-grid-tile__icon');
                  });
              });
          });
      };
       ...
       */
      function (narrow) {
          this._narrow = common.toBoolean(narrow);
       ...
       */
      function (header) {
          this._header = common.toBoolean(header);
          this._changeDetectorRef.markForCheck();
      };
      /**
       * @param {?} aspect
      ...
      MdcGridList.propDecorators = {
          ...
          icons: [{ type: core.ContentChildren, args: [icon.MdcIcon, { descendants: true },] }],
