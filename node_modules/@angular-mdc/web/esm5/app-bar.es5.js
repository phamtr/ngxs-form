 ...
 */
import { ChangeDetectionStrategy, Component, Directive, ElementRef, HostBinding, Input, ChangeDetectorRef, ContentChild, ContentChildren, EventEmitter, Output, ViewEncapsulation, NgModule } from '@angular/core';
...
var MdcAppBarSection = /** @class */ (function () {
    ...
    MdcAppBarSection.decorators = [
        { type: Component, args: [{selector: 'mdc-app-bar-section, [mdcAppBarSection]',
...
var MdcAppBar = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        this.actions.changes.pipe(startWith(null), takeUntil(this._destroy)).subscribe(function () {
            if (_this.short) {
