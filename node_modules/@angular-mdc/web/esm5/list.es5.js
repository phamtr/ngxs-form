...
var MdcList = /** @class */ (function () {
    function MdcList(_changeDetectorRef, _ngZone, elementRef) {
        ...
        this.optionSelectionChanges = defer(function () {
            if (_this._listItems) {
                return merge.apply(void 0, _this._listItems.map(function (option) { return option.selectionChange; }));
            }
    ...
    function () {
        ...
        this.optionSelectionChanges.pipe(takeUntil(merge(this._destroy, this._listItems.changes))).subscribe(function (event) {
            _this.selectionChange.emit(new MdcListItemChange(_this, event.source));
        });
        this._listItems.changes.pipe(startWith(null), takeUntil(this._destroy)).subscribe(function () {
    ...
    function () {
        var _this = this;
        var /** @type {?} */ changedOrDestroyed = merge(this._listItems.changes, this._destroy);
