    ...
    value: function getDefaultFoundation() {
      ...
      return new MDCNotchedOutlineFoundation({
        ...
        setOutlinePathAttr: function setOutlinePathAttr(value) {
          var path = _this.root_.querySelector(strings$1.PATH_SELECTOR);

          path.setAttribute('d', value);
        },
        getIdleOutlineStyleValue: function getIdleOutlineStyleValue(propertyName) {
          var idleOutlineElement = _this.root_.parentNode.querySelector(strings$1.IDLE_OUTLINE_SELECTOR);
...
function (_MDCComponent) {
  ...
  function MDCSelect() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MDCSelect).apply(this, arguments));
  }
...
var /** @type {?} */ MDC_SELECT_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: forwardRef(function () { return MdcSelect; }),
    multi: true
};
...
var MdcSelect = /** @class */ (function () {
    ...
    MdcSelect.propDecorators = {
        ...
        classBox: [{ type: HostBinding, args: ['class.mdc-select--box',] }],
        classOutlined: [{ type: HostBinding, args: ['class.mdc-select--outlined',] }],
