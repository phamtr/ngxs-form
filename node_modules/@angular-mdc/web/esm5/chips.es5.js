...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ContentChildren, ElementRef, EventEmitter, HostBinding, HostListener, Input, Output, ViewEncapsulation, NgZone, NgModule } from '@angular/core';
...
var MdcChipSet = /** @class */ (function () {
    function MdcChipSet(_changeDetectorRef, _ngZone, elementRef, _registry) {
         ...
         */
        this.chipSelectionChanges = defer(function () {
            if (_this.chips) {
                return merge.apply(void 0, _this.chips.map(function (chip) { return chip.selectionChange; }));
            }
            return _this._ngZone.onStable
                .asObservable()
                .pipe(take(1), switchMap(function () { return _this.chipSelectionChanges; }));
        });
        this._mdcAdapter = {
            hasClass: function (className) { return _this._getHostElement().classList.contains(className); },
            registerInteractionHandler: function (evtType, handler) {
    ...
    function () {
        var _this = this;
        this.chipSelectionChanges.pipe(takeUntil(merge(this._destroy, this.chips.changes))).subscribe(function (event) {
            if (!_this.filter) {
        ...
        this.chips.changes.pipe(startWith(null), takeUntil(this._destroy)).subscribe(function () {
